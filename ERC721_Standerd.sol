...
contract ERC721_Standard is ERC721Enumerable, Ownable{
  ...
  constructor(
    ...
    function mint(uint256 Tokenid,uint256 _entertype) public {
    // uint256 BRAWLPOINT=Road_Staking.balances(msg.sender);
    // require(BRAWLPOINT>=MinitngPrice," Not Enough Energy ");
    ...
    // _mintLoop(msg.sender, Tokenid);
    _safeMint(msg.sender, Tokenid);
    mintedNFTs[msg.sender] += Tokenid;
    setType[Tokenid] = _entertype;
...
//   ROAD-STAKING : 0xabAe1C2481cb86479A15081125615d9a7b675d9a
